"use client"; // <--- ADDED DIRECTIVE TO MARK AS CLIENT COMPONENT
...
// Explicitly define the component as a React Functional Component (FC)
const PoemViewerPage: FC = () => {
  ...
  const fontStyle = useMemo(() => {
    ...
    if (fontMode === 'cursive') {
      ...
      // Use Allura as the primary font
  ...
  // Load the first poem on component mount (client-side effect)
  useEffect(() => {
  ...
  return (
    <div className="flex h-screen antialiased" style={{ backgroundColor: '#fdf6e3' /* Light Cream/Parchment Background */ }}>
      {/* 1. External Font Import (In a real Next.js app, this would be in the root Layout file) */}
